                        ...
                        <div class="row" style="margin-bottom:40px">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-control">
                                       {{getCate($categories,0,'',$blog->cate_id)}}
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Tiêu đề</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  class="editor" name="describe"
                                        style="width: 100%;height: 100px;">{{$blog->describe}}</textarea>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="editor1" class="editor1" name="comtent" style="width: 100%;height: 500px;">{!!$blog->content!!}
                                                </textarea>
